...
static c448_error_t hash_init_with_dom(bcrypto_keccak_ctx *hashctx,
                                       uint8_t prehashed,
                                       uint8_t for_prehash,
                        ...
                        size_t context_len)
{
...

    {
        ...
        bcrypto_keccak_update(hashctx, expanded + EDDSA_448_PRIVATE_BYTES,
                                       EDDSA_448_PRIVATE_BYTES);
                    ...
                    uint8_t context_len)
{
...

    {
        ...
        bcrypto_keccak_update(hashctx, signature, EDDSA_448_PUBLIC_BYTES);
        bcrypto_keccak_update(hashctx, pubkey, EDDSA_448_PUBLIC_BYTES);
        bcrypto_keccak_update(hashctx, message, message_len);
