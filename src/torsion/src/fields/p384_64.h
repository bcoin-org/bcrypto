/* Autogenerated: /src/ExtractionOCaml/word_by_word_montgomery --static p384 64 '2^384 - 2^128 - 2^96 + 2^32 - 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes */
...
typedef torsion_int128_t fiat_p384_int128;
typedef torsion_uint128_t fiat_p384_uint128;
...
static void fiat_p384_nonzero(uint64_t* out1, const uint64_t arg1[6]) {
  uint64_t x1;
  x1 = ((arg1[0]) | ((arg1[1]) | ((arg1[2]) | ((arg1[3]) | ((arg1[4]) | ((arg1[5]) | (uint64_t)0x0))))));
  *out1 = x1;
}
