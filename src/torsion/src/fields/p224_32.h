/* Autogenerated: /src/ExtractionOCaml/word_by_word_montgomery --static p224 32 '2^224 - 2^96 + 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes */
...
static void fiat_p224_to_bytes(uint8_t out1[28], const uint32_t arg1[7]) {
  ...
  x42 = (uint8_t)(x40 & UINT8_C(0xff));
  x43 = (x2 >> 8);
  x44 = (uint8_t)(x2 & UINT8_C(0xff));
  x45 = (x43 >> 8);
...
static void fiat_p224_from_bytes(uint32_t out1[7], const uint8_t arg1[28]) {
  ...
  x35 = (x20 + (x19 + (x18 + x17)));
  x36 = (x24 + (x23 + (x22 + x21)));
  x37 = (x36 & UINT32_C(0xffffffff));
  x38 = (x35 & UINT32_C(0xffffffff));
  x39 = (x34 & UINT32_C(0xffffffff));
  x40 = (x33 & UINT32_C(0xffffffff));
  x41 = (x32 & UINT32_C(0xffffffff));
  out1[0] = x30;
  out1[1] = x37;
  out1[2] = x38;
  out1[3] = x39;
