/* Autogenerated: /home/chjj/fiat-crypto/src/ExtractionOCaml/unsaturated_solinas --static p25519 10 '2^255 - 19' 32 carry_mul carry_square carry_scmul121666 carry add sub opp selectznz to_bytes from_bytes */
...
/*
 * The function fiat_p25519_addcarryx_u26 is an addition with carry.
 * Postconditions:
 ...
 *   out2: [0x0 ~> 0x1]
 */
static void fiat_p25519_addcarryx_u26(uint32_t* out1, fiat_p25519_uint1* out2, fiat_p25519_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  uint32_t x1 = ((arg1 + arg2) + arg3);
  uint32_t x2 = (x1 & UINT32_C(0x3ffffff));
  fiat_p25519_uint1 x3 = (fiat_p25519_uint1)(x1 >> 26);
  *out1 = x2;
  *out2 = x3;
}

/*
 * The function fiat_p25519_subborrowx_u26 is a subtraction with borrow.
 * Postconditions:
 *   out1 = (-arg1 + arg2 + -arg3) mod 2^26
 *   out2 = -⌊(-arg1 + arg2 + -arg3) / 2^26⌋
 *
 ...
 *   out2: [0x0 ~> 0x1]
 */
static void fiat_p25519_subborrowx_u26(uint32_t* out1, fiat_p25519_uint1* out2, fiat_p25519_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  int32_t x1 = ((int32_t)(arg2 - arg1) - (int32_t)arg3);
  fiat_p25519_int1 x2 = (fiat_p25519_int1)(x1 >> 26);
...
/*
 * The function fiat_p25519_addcarryx_u25 is an addition with carry.
 * Postconditions:
 ...
 *   out2: [0x0 ~> 0x1]
 */
static void fiat_p25519_addcarryx_u25(uint32_t* out1, fiat_p25519_uint1* out2, fiat_p25519_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  uint32_t x1 = ((arg1 + arg2) + arg3);
  uint32_t x2 = (x1 & UINT32_C(0x1ffffff));
  fiat_p25519_uint1 x3 = (fiat_p25519_uint1)(x1 >> 25);
  *out1 = x2;
  *out2 = x3;
}

/*
 * The function fiat_p25519_subborrowx_u25 is a subtraction with borrow.
 * Postconditions:
 *   out1 = (-arg1 + arg2 + -arg3) mod 2^25
 *   out2 = -⌊(-arg1 + arg2 + -arg3) / 2^25⌋
 *
 ...
 *   out2: [0x0 ~> 0x1]
 */
static void fiat_p25519_subborrowx_u25(uint32_t* out1, fiat_p25519_uint1* out2, fiat_p25519_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  int32_t x1 = ((int32_t)(arg2 - arg1) - (int32_t)arg3);
  fiat_p25519_int1 x2 = (fiat_p25519_int1)(x1 >> 25);
...
/*
 * The function fiat_p25519_cmovznz_u32 is a single-word conditional move.
 * Postconditions:
 ...
 *   out1: [0x0 ~> 0xffffffff]
 */
static void fiat_p25519_cmovznz_u32(uint32_t* out1, fiat_p25519_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  fiat_p25519_uint1 x1 = (!(!arg1));
  uint32_t x2 = ((fiat_p25519_int1)(0x0 - x1) & UINT32_C(0xffffffff));
 ...
 */
static void fiat_p25519_carry_mul(uint32_t out1[10], const uint32_t arg1[10], const uint32_t arg2[10]) {
  uint64_t x1 = ((uint64_t)(arg1[9]) * ((arg2[9]) * (uint32_t)UINT8_C(0x26)));
  uint64_t x2 = ((uint64_t)(arg1[9]) * ((arg2[8]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x3 = ((uint64_t)(arg1[9]) * ((arg2[7]) * (uint32_t)UINT8_C(0x26)));
  uint64_t x4 = ((uint64_t)(arg1[9]) * ((arg2[6]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x5 = ((uint64_t)(arg1[9]) * ((arg2[5]) * (uint32_t)UINT8_C(0x26)));
  uint64_t x6 = ((uint64_t)(arg1[9]) * ((arg2[4]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x7 = ((uint64_t)(arg1[9]) * ((arg2[3]) * (uint32_t)UINT8_C(0x26)));
  uint64_t x8 = ((uint64_t)(arg1[9]) * ((arg2[2]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x9 = ((uint64_t)(arg1[9]) * ((arg2[1]) * (uint32_t)UINT8_C(0x26)));
  ...
  uint64_t x18 = ((uint64_t)(arg1[7]) * ((arg2[9]) * (uint32_t)UINT8_C(0x26)));
  uint64_t x19 = ((uint64_t)(arg1[7]) * ((arg2[8]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x20 = ((uint64_t)(arg1[7]) * ((arg2[7]) * (uint32_t)UINT8_C(0x26)));
  uint64_t x21 = ((uint64_t)(arg1[7]) * ((arg2[6]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x22 = ((uint64_t)(arg1[7]) * ((arg2[5]) * (uint32_t)UINT8_C(0x26)));
  uint64_t x23 = ((uint64_t)(arg1[7]) * ((arg2[4]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x24 = ((uint64_t)(arg1[7]) * ((arg2[3]) * (uint32_t)UINT8_C(0x26)));
  ...
  uint64_t x31 = ((uint64_t)(arg1[5]) * ((arg2[9]) * (uint32_t)UINT8_C(0x26)));
  uint64_t x32 = ((uint64_t)(arg1[5]) * ((arg2[8]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x33 = ((uint64_t)(arg1[5]) * ((arg2[7]) * (uint32_t)UINT8_C(0x26)));
  uint64_t x34 = ((uint64_t)(arg1[5]) * ((arg2[6]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x35 = ((uint64_t)(arg1[5]) * ((arg2[5]) * (uint32_t)UINT8_C(0x26)));
  ...
  uint64_t x40 = ((uint64_t)(arg1[3]) * ((arg2[9]) * (uint32_t)UINT8_C(0x26)));
  uint64_t x41 = ((uint64_t)(arg1[3]) * ((arg2[8]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x42 = ((uint64_t)(arg1[3]) * ((arg2[7]) * (uint32_t)UINT8_C(0x26)));
  uint64_t x43 = ((uint64_t)(arg1[2]) * ((arg2[9]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x44 = ((uint64_t)(arg1[2]) * ((arg2[8]) * (uint32_t)UINT8_C(0x13)));
  uint64_t x45 = ((uint64_t)(arg1[1]) * ((arg2[9]) * (uint32_t)UINT8_C(0x26)));
  ...
  fiat_p25519_uint1 x145 = (fiat_p25519_uint1)(x144 >> 25);
 ...
 *   out1: [[0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333]]
 */
static void fiat_p25519_carry_square(uint32_t out1[10], const uint32_t arg1[10]) {
  ...
  fiat_p25519_uint1 x118 = (fiat_p25519_uint1)(x117 >> 25);
 ...
 *   out1: [[0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333]]
 */
static void fiat_p25519_carry_scmul_121666(uint32_t out1[10], const uint32_t arg1[10]) {
  ...
  fiat_p25519_uint1 x42 = (fiat_p25519_uint1)(x41 >> 26);
  uint32_t x43 = (x41 & UINT32_C(0x3ffffff));
  uint32_t x44 = (x42 + x15);
  fiat_p25519_uint1 x45 = (fiat_p25519_uint1)(x44 >> 25);
 ...
 *   out1: [[0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333]]
 */
static void fiat_p25519_carry(uint32_t out1[10], const uint32_t arg1[10]) {
  uint32_t x1 = (arg1[0]);
  ...
  uint32_t x12 = ((fiat_p25519_uint1)(x11 >> 26) + (x2 & UINT32_C(0x1ffffff)));
  uint32_t x13 = (x11 & UINT32_C(0x3ffffff));
  uint32_t x14 = (x12 & UINT32_C(0x1ffffff));
  uint32_t x15 = ((fiat_p25519_uint1)(x12 >> 25) + (x3 & UINT32_C(0x3ffffff)));
 ...
 */
static void fiat_p25519_add(uint32_t out1[10], const uint32_t arg1[10], const uint32_t arg2[10]) {
 ...
 *   out1: [[0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0xd333332], [0x0 ~> 0x6999999]]
 */
static void fiat_p25519_sub(uint32_t out1[10], const uint32_t arg1[10], const uint32_t arg2[10]) {
 ...
 *   out1: [[0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0xd333332], [0x0 ~> 0x6999999]]
 */
static void fiat_p25519_opp(uint32_t out1[10], const uint32_t arg1[10]) {
 ...
 */
static void fiat_p25519_selectznz(uint32_t out1[10], fiat_p25519_uint1 arg1, const uint32_t arg2[10], const uint32_t arg3[10]) {
  uint32_t x1;
  fiat_p25519_cmovznz_u32(&x1, arg1, (arg2[0]), (arg3[0]));
  uint32_t x2;
  fiat_p25519_cmovznz_u32(&x2, arg1, (arg2[1]), (arg3[1]));
  uint32_t x3;
  fiat_p25519_cmovznz_u32(&x3, arg1, (arg2[2]), (arg3[2]));
  uint32_t x4;
  fiat_p25519_cmovznz_u32(&x4, arg1, (arg2[3]), (arg3[3]));
  uint32_t x5;
  fiat_p25519_cmovznz_u32(&x5, arg1, (arg2[4]), (arg3[4]));
  uint32_t x6;
  fiat_p25519_cmovznz_u32(&x6, arg1, (arg2[5]), (arg3[5]));
  uint32_t x7;
  fiat_p25519_cmovznz_u32(&x7, arg1, (arg2[6]), (arg3[6]));
  uint32_t x8;
  fiat_p25519_cmovznz_u32(&x8, arg1, (arg2[7]), (arg3[7]));
  uint32_t x9;
  fiat_p25519_cmovznz_u32(&x9, arg1, (arg2[8]), (arg3[8]));
  uint32_t x10;
  fiat_p25519_cmovznz_u32(&x10, arg1, (arg2[9]), (arg3[9]));
  out1[0] = x1;
  out1[1] = x2;
  out1[2] = x3;
  out1[3] = x4;
 ...
 */
static void fiat_p25519_to_bytes(uint8_t out1[32], const uint32_t arg1[10]) {
  uint32_t x1;
  fiat_p25519_uint1 x2;
  fiat_p25519_subborrowx_u26(&x1, &x2, 0x0, (arg1[0]), UINT32_C(0x3ffffed));
  uint32_t x3;
  fiat_p25519_uint1 x4;
  fiat_p25519_subborrowx_u25(&x3, &x4, x2, (arg1[1]), UINT32_C(0x1ffffff));
  uint32_t x5;
  fiat_p25519_uint1 x6;
  fiat_p25519_subborrowx_u26(&x5, &x6, x4, (arg1[2]), UINT32_C(0x3ffffff));
  uint32_t x7;
  fiat_p25519_uint1 x8;
  fiat_p25519_subborrowx_u25(&x7, &x8, x6, (arg1[3]), UINT32_C(0x1ffffff));
  uint32_t x9;
  fiat_p25519_uint1 x10;
  fiat_p25519_subborrowx_u26(&x9, &x10, x8, (arg1[4]), UINT32_C(0x3ffffff));
  uint32_t x11;
  fiat_p25519_uint1 x12;
  fiat_p25519_subborrowx_u25(&x11, &x12, x10, (arg1[5]), UINT32_C(0x1ffffff));
  uint32_t x13;
  fiat_p25519_uint1 x14;
  fiat_p25519_subborrowx_u26(&x13, &x14, x12, (arg1[6]), UINT32_C(0x3ffffff));
  uint32_t x15;
  fiat_p25519_uint1 x16;
  fiat_p25519_subborrowx_u25(&x15, &x16, x14, (arg1[7]), UINT32_C(0x1ffffff));
  uint32_t x17;
  fiat_p25519_uint1 x18;
  fiat_p25519_subborrowx_u26(&x17, &x18, x16, (arg1[8]), UINT32_C(0x3ffffff));
  uint32_t x19;
  fiat_p25519_uint1 x20;
  fiat_p25519_subborrowx_u25(&x19, &x20, x18, (arg1[9]), UINT32_C(0x1ffffff));
  uint32_t x21;
  fiat_p25519_cmovznz_u32(&x21, x20, 0x0, UINT32_C(0xffffffff));
  uint32_t x22;
  fiat_p25519_uint1 x23;
  fiat_p25519_addcarryx_u26(&x22, &x23, 0x0, x1, (x21 & UINT32_C(0x3ffffed)));
  uint32_t x24;
  fiat_p25519_uint1 x25;
  fiat_p25519_addcarryx_u25(&x24, &x25, x23, x3, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x26;
  fiat_p25519_uint1 x27;
  fiat_p25519_addcarryx_u26(&x26, &x27, x25, x5, (x21 & UINT32_C(0x3ffffff)));
  uint32_t x28;
  fiat_p25519_uint1 x29;
  fiat_p25519_addcarryx_u25(&x28, &x29, x27, x7, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x30;
  fiat_p25519_uint1 x31;
  fiat_p25519_addcarryx_u26(&x30, &x31, x29, x9, (x21 & UINT32_C(0x3ffffff)));
  uint32_t x32;
  fiat_p25519_uint1 x33;
  fiat_p25519_addcarryx_u25(&x32, &x33, x31, x11, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x34;
  fiat_p25519_uint1 x35;
  fiat_p25519_addcarryx_u26(&x34, &x35, x33, x13, (x21 & UINT32_C(0x3ffffff)));
  uint32_t x36;
  fiat_p25519_uint1 x37;
  fiat_p25519_addcarryx_u25(&x36, &x37, x35, x15, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x38;
  fiat_p25519_uint1 x39;
  fiat_p25519_addcarryx_u26(&x38, &x39, x37, x17, (x21 & UINT32_C(0x3ffffff)));
  uint32_t x40;
  fiat_p25519_uint1 x41;
  fiat_p25519_addcarryx_u25(&x40, &x41, x39, x19, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x42 = (x40 << 6);
  uint32_t x43 = (x38 << 4);
  uint32_t x44 = (x36 << 3);
  ...
  fiat_p25519_uint1 x89 = (fiat_p25519_uint1)(x87 >> 8);
 ...
 *   out1: [[0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x4666666], [0x0 ~> 0x2333333]]
 */
static void fiat_p25519_from_bytes(uint32_t out1[10], const uint8_t arg1[32]) {
