/* Autogenerated: /home/chjj/fiat-crypto/src/ExtractionOCaml/unsaturated_solinas --static p251 5 '2^251 - 9' 64 */
...
TORSION_EXTENSION typedef signed __int128 fiat_p251_int128;
TORSION_EXTENSION typedef unsigned __int128 fiat_p251_uint128;
...
static void fiat_p251_addcarryx_u50(uint64_t* out1, fiat_p251_uint1* out2, fiat_p251_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  ...
  uint64_t x2 = (x1 & UINT64_C(0x3ffffffffffff));
  fiat_p251_uint1 x3 = (fiat_p251_uint1)(x1 >> 50);
  *out1 = x2;
  *out2 = x3;
}
...
static void fiat_p251_subborrowx_u50(uint64_t* out1, fiat_p251_uint1* out2, fiat_p251_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  ...
  fiat_p251_int1 x2 = (fiat_p251_int1)(x1 >> 50);
  uint64_t x3 = (x1 & UINT64_C(0x3ffffffffffff));
  *out1 = x3;
...
static void fiat_p251_addcarryx_u51(uint64_t* out1, fiat_p251_uint1* out2, fiat_p251_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  ...
  fiat_p251_uint1 x3 = (fiat_p251_uint1)(x1 >> 51);
  *out1 = x2;
  *out2 = x3;
}
...
static void fiat_p251_subborrowx_u51(uint64_t* out1, fiat_p251_uint1* out2, fiat_p251_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  int64_t x1 = ((int64_t)(arg2 - (int64_t)arg1) - (int64_t)arg3);
  fiat_p251_int1 x2 = (fiat_p251_int1)(x1 >> 51);
...
static void fiat_p251_carry_mul(uint64_t out1[5], const uint64_t arg1[5], const uint64_t arg2[5]) {
  fiat_p251_uint128 x1 = ((fiat_p251_uint128)(arg1[4]) * ((arg2[4]) * (uint64_t)0x9));
  fiat_p251_uint128 x2 = ((fiat_p251_uint128)(arg1[4]) * ((arg2[3]) * (uint64_t)0x9));
  fiat_p251_uint128 x3 = ((fiat_p251_uint128)(arg1[4]) * ((arg2[2]) * (uint64_t)0x9));
  fiat_p251_uint128 x4 = ((fiat_p251_uint128)(arg1[4]) * ((arg2[1]) * (uint64_t)UINT8_C(0x12)));
  fiat_p251_uint128 x5 = ((fiat_p251_uint128)(arg1[3]) * ((arg2[4]) * (uint64_t)0x9));
  fiat_p251_uint128 x6 = ((fiat_p251_uint128)(arg1[3]) * ((arg2[3]) * (uint64_t)0x9));
  fiat_p251_uint128 x7 = ((fiat_p251_uint128)(arg1[3]) * ((arg2[2]) * (uint64_t)UINT8_C(0x12)));
  fiat_p251_uint128 x8 = ((fiat_p251_uint128)(arg1[2]) * ((arg2[4]) * (uint64_t)0x9));
  fiat_p251_uint128 x9 = ((fiat_p251_uint128)(arg1[2]) * ((arg2[3]) * (uint64_t)UINT8_C(0x12)));
  fiat_p251_uint128 x10 = ((fiat_p251_uint128)(arg1[1]) * ((arg2[4]) * (uint64_t)UINT8_C(0x12)));
  fiat_p251_uint128 x11 = ((fiat_p251_uint128)(arg1[4]) * (arg2[0]));
  fiat_p251_uint128 x12 = ((fiat_p251_uint128)(arg1[3]) * ((arg2[1]) * (uint64_t)0x2));
  fiat_p251_uint128 x13 = ((fiat_p251_uint128)(arg1[3]) * (arg2[0]));
  fiat_p251_uint128 x14 = ((fiat_p251_uint128)(arg1[2]) * ((arg2[2]) * (uint64_t)0x2));
  fiat_p251_uint128 x15 = ((fiat_p251_uint128)(arg1[2]) * ((arg2[1]) * (uint64_t)0x2));
  fiat_p251_uint128 x16 = ((fiat_p251_uint128)(arg1[2]) * (arg2[0]));
  fiat_p251_uint128 x17 = ((fiat_p251_uint128)(arg1[1]) * ((arg2[3]) * (uint64_t)0x2));
  fiat_p251_uint128 x18 = ((fiat_p251_uint128)(arg1[1]) * ((arg2[2]) * (uint64_t)0x2));
  fiat_p251_uint128 x19 = ((fiat_p251_uint128)(arg1[1]) * ((arg2[1]) * (uint64_t)0x2));
  fiat_p251_uint128 x20 = ((fiat_p251_uint128)(arg1[1]) * (arg2[0]));
  fiat_p251_uint128 x21 = ((fiat_p251_uint128)(arg1[0]) * (arg2[4]));
  fiat_p251_uint128 x22 = ((fiat_p251_uint128)(arg1[0]) * (arg2[3]));
  fiat_p251_uint128 x23 = ((fiat_p251_uint128)(arg1[0]) * (arg2[2]));
  fiat_p251_uint128 x24 = ((fiat_p251_uint128)(arg1[0]) * (arg2[1]));
  fiat_p251_uint128 x25 = ((fiat_p251_uint128)(arg1[0]) * (arg2[0]));
  fiat_p251_uint128 x26 = (x25 + (x10 + (x9 + (x7 + x4))));
  uint64_t x27 = (uint64_t)(x26 >> 51);
  uint64_t x28 = (uint64_t)(x26 & UINT64_C(0x7ffffffffffff));
  fiat_p251_uint128 x29 = (x21 + (x17 + (x14 + (x12 + x11))));
  fiat_p251_uint128 x30 = (x22 + (x18 + (x15 + (x13 + x1))));
  fiat_p251_uint128 x31 = (x23 + (x19 + (x16 + (x5 + x2))));
  fiat_p251_uint128 x32 = (x24 + (x20 + (x8 + (x6 + x3))));
  fiat_p251_uint128 x33 = (x27 + x32);
  uint64_t x34 = (uint64_t)(x33 >> 50);
  uint64_t x35 = (uint64_t)(x33 & UINT64_C(0x3ffffffffffff));
  fiat_p251_uint128 x36 = (x34 + x31);
  uint64_t x37 = (uint64_t)(x36 >> 50);
  uint64_t x38 = (uint64_t)(x36 & UINT64_C(0x3ffffffffffff));
  fiat_p251_uint128 x39 = (x37 + x30);
  uint64_t x40 = (uint64_t)(x39 >> 50);
  uint64_t x41 = (uint64_t)(x39 & UINT64_C(0x3ffffffffffff));
  fiat_p251_uint128 x42 = (x40 + x29);
  uint64_t x43 = (uint64_t)(x42 >> 50);
  uint64_t x44 = (uint64_t)(x42 & UINT64_C(0x3ffffffffffff));
  uint64_t x45 = (x43 * (uint64_t)0x9);
  uint64_t x46 = (x28 + x45);
  uint64_t x47 = (x46 >> 51);
  uint64_t x48 = (x46 & UINT64_C(0x7ffffffffffff));
  uint64_t x49 = (x47 + x35);
  fiat_p251_uint1 x50 = (fiat_p251_uint1)(x49 >> 50);
  uint64_t x51 = (x49 & UINT64_C(0x3ffffffffffff));
...
static void fiat_p251_carry_square(uint64_t out1[5], const uint64_t arg1[5]) {
  uint64_t x1 = ((arg1[4]) * (uint64_t)0x9);
  uint64_t x2 = (x1 * (uint64_t)0x2);
  uint64_t x3 = ((arg1[4]) * (uint64_t)0x2);
  uint64_t x4 = ((arg1[3]) * (uint64_t)0x9);
  uint64_t x5 = (x4 * (uint64_t)0x2);
  uint64_t x6 = ((arg1[3]) * (uint64_t)0x2);
  uint64_t x7 = ((arg1[2]) * (uint64_t)0x2);
  uint64_t x8 = ((arg1[1]) * (uint64_t)0x2);
  fiat_p251_uint128 x9 = ((fiat_p251_uint128)(arg1[4]) * x1);
  fiat_p251_uint128 x10 = ((fiat_p251_uint128)(arg1[3]) * x2);
  fiat_p251_uint128 x11 = ((fiat_p251_uint128)(arg1[3]) * x4);
  fiat_p251_uint128 x12 = ((fiat_p251_uint128)(arg1[2]) * x2);
  fiat_p251_uint128 x13 = ((fiat_p251_uint128)(arg1[2]) * (x5 * (uint64_t)0x2));
  fiat_p251_uint128 x14 = ((fiat_p251_uint128)(arg1[2]) * ((arg1[2]) * (uint64_t)0x2));
  fiat_p251_uint128 x15 = ((fiat_p251_uint128)(arg1[1]) * (x2 * (uint64_t)0x2));
  fiat_p251_uint128 x16 = ((fiat_p251_uint128)(arg1[1]) * (x6 * (uint64_t)0x2));
  fiat_p251_uint128 x17 = ((fiat_p251_uint128)(arg1[1]) * (x7 * (uint64_t)0x2));
  fiat_p251_uint128 x18 = ((fiat_p251_uint128)(arg1[1]) * ((arg1[1]) * (uint64_t)0x2));
  fiat_p251_uint128 x19 = ((fiat_p251_uint128)(arg1[0]) * x3);
  fiat_p251_uint128 x20 = ((fiat_p251_uint128)(arg1[0]) * x6);
  fiat_p251_uint128 x21 = ((fiat_p251_uint128)(arg1[0]) * x7);
  fiat_p251_uint128 x22 = ((fiat_p251_uint128)(arg1[0]) * x8);
  fiat_p251_uint128 x23 = ((fiat_p251_uint128)(arg1[0]) * (arg1[0]));
  fiat_p251_uint128 x24 = (x23 + (x15 + x13));
  uint64_t x25 = (uint64_t)(x24 >> 51);
  uint64_t x26 = (uint64_t)(x24 & UINT64_C(0x7ffffffffffff));
  fiat_p251_uint128 x27 = (x19 + (x16 + x14));
  fiat_p251_uint128 x28 = (x20 + (x17 + x9));
  fiat_p251_uint128 x29 = (x21 + (x18 + x10));
  fiat_p251_uint128 x30 = (x22 + (x12 + x11));
  fiat_p251_uint128 x31 = (x25 + x30);
  uint64_t x32 = (uint64_t)(x31 >> 50);
  uint64_t x33 = (uint64_t)(x31 & UINT64_C(0x3ffffffffffff));
  fiat_p251_uint128 x34 = (x32 + x29);
  uint64_t x35 = (uint64_t)(x34 >> 50);
  uint64_t x36 = (uint64_t)(x34 & UINT64_C(0x3ffffffffffff));
  fiat_p251_uint128 x37 = (x35 + x28);
  uint64_t x38 = (uint64_t)(x37 >> 50);
  uint64_t x39 = (uint64_t)(x37 & UINT64_C(0x3ffffffffffff));
  fiat_p251_uint128 x40 = (x38 + x27);
  uint64_t x41 = (uint64_t)(x40 >> 50);
  uint64_t x42 = (uint64_t)(x40 & UINT64_C(0x3ffffffffffff));
  uint64_t x43 = (x41 * (uint64_t)0x9);
  uint64_t x44 = (x26 + x43);
  uint64_t x45 = (x44 >> 51);
  uint64_t x46 = (x44 & UINT64_C(0x7ffffffffffff));
  uint64_t x47 = (x45 + x33);
  fiat_p251_uint1 x48 = (fiat_p251_uint1)(x47 >> 50);
  uint64_t x49 = (x47 & UINT64_C(0x3ffffffffffff));
...
static void fiat_p251_carry(uint64_t out1[5], const uint64_t arg1[5]) {
  ...
  uint64_t x3 = ((x2 >> 50) + (arg1[2]));
  uint64_t x4 = ((x3 >> 50) + (arg1[3]));
  uint64_t x5 = ((x4 >> 50) + (arg1[4]));
  uint64_t x6 = ((x1 & UINT64_C(0x7ffffffffffff)) + ((x5 >> 50) * (uint64_t)0x9));
  uint64_t x7 = ((fiat_p251_uint1)(x6 >> 51) + (x2 & UINT64_C(0x3ffffffffffff)));
  uint64_t x8 = (x6 & UINT64_C(0x7ffffffffffff));
  uint64_t x9 = (x7 & UINT64_C(0x3ffffffffffff));
  uint64_t x10 = ((fiat_p251_uint1)(x7 >> 50) + (x3 & UINT64_C(0x3ffffffffffff)));
  uint64_t x11 = (x4 & UINT64_C(0x3ffffffffffff));
  uint64_t x12 = (x5 & UINT64_C(0x3ffffffffffff));
  out1[0] = x8;
  out1[1] = x9;
  out1[2] = x10;
  out1[3] = x11;
...
static void fiat_p251_sub(uint64_t out1[5], const uint64_t arg1[5], const uint64_t arg2[5]) {
  uint64_t x1 = ((UINT64_C(0xfffffffffffee) + (arg1[0])) - (arg2[0]));
  uint64_t x2 = ((UINT64_C(0x7fffffffffffe) + (arg1[1])) - (arg2[1]));
  uint64_t x3 = ((UINT64_C(0x7fffffffffffe) + (arg1[2])) - (arg2[2]));
  uint64_t x4 = ((UINT64_C(0x7fffffffffffe) + (arg1[3])) - (arg2[3]));
  uint64_t x5 = ((UINT64_C(0x7fffffffffffe) + (arg1[4])) - (arg2[4]));
  out1[0] = x1;
  out1[1] = x2;
  out1[2] = x3;
  out1[3] = x4;
...
static void fiat_p251_opp(uint64_t out1[5], const uint64_t arg1[5]) {
  uint64_t x1 = (UINT64_C(0xfffffffffffee) - (arg1[0]));
  uint64_t x2 = (UINT64_C(0x7fffffffffffe) - (arg1[1]));
  uint64_t x3 = (UINT64_C(0x7fffffffffffe) - (arg1[2]));
  uint64_t x4 = (UINT64_C(0x7fffffffffffe) - (arg1[3]));
  uint64_t x5 = (UINT64_C(0x7fffffffffffe) - (arg1[4]));
  out1[0] = x1;
  out1[1] = x2;
  out1[2] = x3;
  out1[3] = x4;
...
static void fiat_p251_to_bytes(uint8_t out1[32], const uint64_t arg1[5]) {
  ...
  fiat_p251_uint1 x77 = (fiat_p251_uint1)(x75 >> 8);
...
static void fiat_p251_from_bytes(uint64_t out1[5], const uint8_t arg1[32]) {
  ...
  uint64_t x2 = ((uint64_t)(arg1[30]) << 39);
  uint64_t x3 = ((uint64_t)(arg1[29]) << 31);
  uint64_t x4 = ((uint64_t)(arg1[28]) << 23);
  uint64_t x5 = ((uint64_t)(arg1[27]) << 15);
  uint64_t x6 = ((uint64_t)(arg1[26]) << 7);
  uint64_t x7 = ((uint64_t)(arg1[25]) << 49);
  uint64_t x8 = ((uint64_t)(arg1[24]) << 41);
  uint64_t x9 = ((uint64_t)(arg1[23]) << 33);
  uint64_t x10 = ((uint64_t)(arg1[22]) << 25);
  uint64_t x11 = ((uint64_t)(arg1[21]) << 17);
  uint64_t x12 = ((uint64_t)(arg1[20]) << 9);
  uint64_t x13 = ((uint64_t)(arg1[19]) * 0x2);
  uint64_t x14 = ((uint64_t)(arg1[18]) << 43);
  uint64_t x15 = ((uint64_t)(arg1[17]) << 35);
  uint64_t x16 = ((uint64_t)(arg1[16]) << 27);
  uint64_t x17 = ((uint64_t)(arg1[15]) << 19);
  uint64_t x18 = ((uint64_t)(arg1[14]) << 11);
  uint64_t x19 = ((uint64_t)(arg1[13]) << 3);
  ...
  uint64_t x37 = (x13 + (x12 + (x11 + (x10 + (x9 + (x8 + x7))))));
  uint64_t x38 = (x19 + (x18 + (x17 + (x16 + (x15 + x14)))));
  uint64_t x39 = (x25 + (x24 + (x23 + (x22 + (x21 + x20)))));
  uint64_t x40 = (x34 + x39);
  uint8_t x41 = (uint8_t)(x40 >> 50);
  uint64_t x42 = (x40 & UINT64_C(0x3ffffffffffff));
  uint64_t x43 = (x41 + x38);
  fiat_p251_uint1 x44 = (fiat_p251_uint1)(x43 >> 50);
  uint64_t x45 = (x43 & UINT64_C(0x3ffffffffffff));
  uint64_t x46 = (x44 + x37);
  uint8_t x47 = (uint8_t)(x46 >> 50);
  uint64_t x48 = (x46 & UINT64_C(0x3ffffffffffff));
