/* Autogenerated: /src/ExtractionOCaml/word_by_word_montgomery --static p224 64 '2^224 - 2^96 + 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes */
...
static void fiat_p224_from_bytes(uint64_t out1[4], const uint8_t arg1[32]) {
  ...
  x30 = (x29 & UINT64_C(0xffffffffffffffff));
  x31 = (x4 + (x3 + (x2 + x1)));
  x32 = (x12 + (x11 + (x10 + (x9 + (x8 + (x7 + (x6 + x5)))))));
  x33 = (x20 + (x19 + (x18 + (x17 + (x16 + (x15 + (x14 + x13)))))));
  x34 = (x33 & UINT64_C(0xffffffffffffffff));
  x35 = (x32 & UINT64_C(0xffffffffffffffff));
  out1[0] = x30;
  out1[1] = x34;
  out1[2] = x35;
  out1[3] = x31;
