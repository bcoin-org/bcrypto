/* Autogenerated: /src/ExtractionOCaml/unsaturated_solinas --static p192 64 4 '2^192 - 2^64 - 1' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes */
