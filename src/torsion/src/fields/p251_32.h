/* Autogenerated: /home/chjj/fiat-crypto/src/ExtractionOCaml/unsaturated_solinas --static p251 10 '2^251 - 9' 32 */
...
/*
 * The function fiat_p251_addcarryx_u26 is an addition with carry.
 * Postconditions:
 ...
 *   out2: [0x0 ~> 0x1]
 */
static void fiat_p251_addcarryx_u26(uint32_t* out1, fiat_p251_uint1* out2, fiat_p251_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  uint32_t x1 = ((arg1 + arg2) + arg3);
  uint32_t x2 = (x1 & UINT32_C(0x3ffffff));
  fiat_p251_uint1 x3 = (fiat_p251_uint1)(x1 >> 26);
  *out1 = x2;
  *out2 = x3;
}

/*
 * The function fiat_p251_subborrowx_u26 is a subtraction with borrow.
 * Postconditions:
 *   out1 = (-arg1 + arg2 + -arg3) mod 2^26
 *   out2 = -⌊(-arg1 + arg2 + -arg3) / 2^26⌋
 *
 ...
 *   out2: [0x0 ~> 0x1]
 */
static void fiat_p251_subborrowx_u26(uint32_t* out1, fiat_p251_uint1* out2, fiat_p251_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  int32_t x1 = ((int32_t)(arg2 - arg1) - (int32_t)arg3);
  fiat_p251_int1 x2 = (fiat_p251_int1)(x1 >> 26);
...
/*
 * The function fiat_p251_addcarryx_u25 is an addition with carry.
 * Postconditions:
 ...
 *   out2: [0x0 ~> 0x1]
 */
static void fiat_p251_addcarryx_u25(uint32_t* out1, fiat_p251_uint1* out2, fiat_p251_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  uint32_t x1 = ((arg1 + arg2) + arg3);
  uint32_t x2 = (x1 & UINT32_C(0x1ffffff));
  fiat_p251_uint1 x3 = (fiat_p251_uint1)(x1 >> 25);
  *out1 = x2;
  *out2 = x3;
}

/*
 * The function fiat_p251_subborrowx_u25 is a subtraction with borrow.
 * Postconditions:
 *   out1 = (-arg1 + arg2 + -arg3) mod 2^25
 *   out2 = -⌊(-arg1 + arg2 + -arg3) / 2^25⌋
 *
 ...
 *   out2: [0x0 ~> 0x1]
 */
static void fiat_p251_subborrowx_u25(uint32_t* out1, fiat_p251_uint1* out2, fiat_p251_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  int32_t x1 = ((int32_t)(arg2 - arg1) - (int32_t)arg3);
  fiat_p251_int1 x2 = (fiat_p251_int1)(x1 >> 25);
 ...
 *
 * Input Bounds:
 *   arg1: [[0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999]]
 *   arg2: [[0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999]]
 * Output Bounds:
 *   out1: [[0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333]]
 */
static void fiat_p251_carry_mul(uint32_t out1[10], const uint32_t arg1[10], const uint32_t arg2[10]) {
  uint64_t x1 = ((uint64_t)(arg1[9]) * ((arg2[9]) * (uint32_t)0x9));
  uint64_t x2 = ((uint64_t)(arg1[9]) * ((arg2[8]) * (uint32_t)0x9));
  uint64_t x3 = ((uint64_t)(arg1[9]) * ((arg2[7]) * (uint32_t)0x9));
  uint64_t x4 = ((uint64_t)(arg1[9]) * ((arg2[6]) * (uint32_t)0x9));
  uint64_t x5 = ((uint64_t)(arg1[9]) * ((arg2[5]) * (uint32_t)0x9));
  uint64_t x6 = ((uint64_t)(arg1[9]) * ((arg2[4]) * (uint32_t)0x9));
  uint64_t x7 = ((uint64_t)(arg1[9]) * ((arg2[3]) * (uint32_t)0x9));
  uint64_t x8 = ((uint64_t)(arg1[9]) * ((arg2[2]) * (uint32_t)0x9));
  uint64_t x9 = ((uint64_t)(arg1[9]) * ((arg2[1]) * (uint32_t)UINT8_C(0x12)));
  uint64_t x10 = ((uint64_t)(arg1[8]) * ((arg2[9]) * (uint32_t)0x9));
  uint64_t x11 = ((uint64_t)(arg1[8]) * ((arg2[8]) * (uint32_t)0x9));
  uint64_t x12 = ((uint64_t)(arg1[8]) * ((arg2[7]) * (uint32_t)0x9));
  uint64_t x13 = ((uint64_t)(arg1[8]) * ((arg2[6]) * (uint32_t)0x9));
  uint64_t x14 = ((uint64_t)(arg1[8]) * ((arg2[5]) * (uint32_t)0x9));
  uint64_t x15 = ((uint64_t)(arg1[8]) * ((arg2[4]) * (uint32_t)0x9));
  uint64_t x16 = ((uint64_t)(arg1[8]) * ((arg2[3]) * (uint32_t)0x9));
  uint64_t x17 = ((uint64_t)(arg1[8]) * ((arg2[2]) * (uint32_t)UINT8_C(0x12)));
  uint64_t x18 = ((uint64_t)(arg1[7]) * ((arg2[9]) * (uint32_t)0x9));
  uint64_t x19 = ((uint64_t)(arg1[7]) * ((arg2[8]) * (uint32_t)0x9));
  uint64_t x20 = ((uint64_t)(arg1[7]) * ((arg2[7]) * (uint32_t)0x9));
  uint64_t x21 = ((uint64_t)(arg1[7]) * ((arg2[6]) * (uint32_t)0x9));
  uint64_t x22 = ((uint64_t)(arg1[7]) * ((arg2[5]) * (uint32_t)0x9));
  uint64_t x23 = ((uint64_t)(arg1[7]) * ((arg2[4]) * (uint32_t)0x9));
  uint64_t x24 = ((uint64_t)(arg1[7]) * ((arg2[3]) * (uint32_t)UINT8_C(0x12)));
  uint64_t x25 = ((uint64_t)(arg1[6]) * ((arg2[9]) * (uint32_t)0x9));
  uint64_t x26 = ((uint64_t)(arg1[6]) * ((arg2[8]) * (uint32_t)0x9));
  uint64_t x27 = ((uint64_t)(arg1[6]) * ((arg2[7]) * (uint32_t)0x9));
  uint64_t x28 = ((uint64_t)(arg1[6]) * ((arg2[6]) * (uint32_t)0x9));
  uint64_t x29 = ((uint64_t)(arg1[6]) * ((arg2[5]) * (uint32_t)0x9));
  uint64_t x30 = ((uint64_t)(arg1[6]) * ((arg2[4]) * (uint32_t)UINT8_C(0x12)));
  uint64_t x31 = ((uint64_t)(arg1[5]) * ((arg2[9]) * (uint32_t)0x9));
  uint64_t x32 = ((uint64_t)(arg1[5]) * ((arg2[8]) * (uint32_t)0x9));
  uint64_t x33 = ((uint64_t)(arg1[5]) * ((arg2[7]) * (uint32_t)0x9));
  uint64_t x34 = ((uint64_t)(arg1[5]) * ((arg2[6]) * (uint32_t)0x9));
  uint64_t x35 = ((uint64_t)(arg1[5]) * ((arg2[5]) * (uint32_t)UINT8_C(0x12)));
  uint64_t x36 = ((uint64_t)(arg1[4]) * ((arg2[9]) * (uint32_t)0x9));
  uint64_t x37 = ((uint64_t)(arg1[4]) * ((arg2[8]) * (uint32_t)0x9));
  uint64_t x38 = ((uint64_t)(arg1[4]) * ((arg2[7]) * (uint32_t)0x9));
  uint64_t x39 = ((uint64_t)(arg1[4]) * ((arg2[6]) * (uint32_t)UINT8_C(0x12)));
  uint64_t x40 = ((uint64_t)(arg1[3]) * ((arg2[9]) * (uint32_t)0x9));
  uint64_t x41 = ((uint64_t)(arg1[3]) * ((arg2[8]) * (uint32_t)0x9));
  uint64_t x42 = ((uint64_t)(arg1[3]) * ((arg2[7]) * (uint32_t)UINT8_C(0x12)));
  uint64_t x43 = ((uint64_t)(arg1[2]) * ((arg2[9]) * (uint32_t)0x9));
  uint64_t x44 = ((uint64_t)(arg1[2]) * ((arg2[8]) * (uint32_t)UINT8_C(0x12)));
  uint64_t x45 = ((uint64_t)(arg1[1]) * ((arg2[9]) * (uint32_t)UINT8_C(0x12)));
  uint64_t x46 = ((uint64_t)(arg1[9]) * (arg2[0]));
  uint64_t x47 = ((uint64_t)(arg1[8]) * ((arg2[1]) * (uint32_t)0x2));
  uint64_t x48 = ((uint64_t)(arg1[8]) * (arg2[0]));
  uint64_t x49 = ((uint64_t)(arg1[7]) * ((arg2[2]) * (uint32_t)0x2));
  uint64_t x50 = ((uint64_t)(arg1[7]) * ((arg2[1]) * (uint32_t)0x2));
  uint64_t x51 = ((uint64_t)(arg1[7]) * (arg2[0]));
  uint64_t x52 = ((uint64_t)(arg1[6]) * ((arg2[3]) * (uint32_t)0x2));
  uint64_t x53 = ((uint64_t)(arg1[6]) * ((arg2[2]) * (uint32_t)0x2));
  uint64_t x54 = ((uint64_t)(arg1[6]) * ((arg2[1]) * (uint32_t)0x2));
  uint64_t x55 = ((uint64_t)(arg1[6]) * (arg2[0]));
  uint64_t x56 = ((uint64_t)(arg1[5]) * ((arg2[4]) * (uint32_t)0x2));
  uint64_t x57 = ((uint64_t)(arg1[5]) * ((arg2[3]) * (uint32_t)0x2));
  uint64_t x58 = ((uint64_t)(arg1[5]) * ((arg2[2]) * (uint32_t)0x2));
  uint64_t x59 = ((uint64_t)(arg1[5]) * ((arg2[1]) * (uint32_t)0x2));
  uint64_t x60 = ((uint64_t)(arg1[5]) * (arg2[0]));
  uint64_t x61 = ((uint64_t)(arg1[4]) * ((arg2[5]) * (uint32_t)0x2));
  uint64_t x62 = ((uint64_t)(arg1[4]) * ((arg2[4]) * (uint32_t)0x2));
  uint64_t x63 = ((uint64_t)(arg1[4]) * ((arg2[3]) * (uint32_t)0x2));
  uint64_t x64 = ((uint64_t)(arg1[4]) * ((arg2[2]) * (uint32_t)0x2));
  uint64_t x65 = ((uint64_t)(arg1[4]) * ((arg2[1]) * (uint32_t)0x2));
  uint64_t x66 = ((uint64_t)(arg1[4]) * (arg2[0]));
  uint64_t x67 = ((uint64_t)(arg1[3]) * ((arg2[6]) * (uint32_t)0x2));
  uint64_t x68 = ((uint64_t)(arg1[3]) * ((arg2[5]) * (uint32_t)0x2));
  uint64_t x69 = ((uint64_t)(arg1[3]) * ((arg2[4]) * (uint32_t)0x2));
  uint64_t x70 = ((uint64_t)(arg1[3]) * ((arg2[3]) * (uint32_t)0x2));
  uint64_t x71 = ((uint64_t)(arg1[3]) * ((arg2[2]) * (uint32_t)0x2));
  ...
  uint64_t x75 = ((uint64_t)(arg1[2]) * ((arg2[6]) * (uint32_t)0x2));
  uint64_t x76 = ((uint64_t)(arg1[2]) * ((arg2[5]) * (uint32_t)0x2));
  uint64_t x77 = ((uint64_t)(arg1[2]) * ((arg2[4]) * (uint32_t)0x2));
  uint64_t x78 = ((uint64_t)(arg1[2]) * ((arg2[3]) * (uint32_t)0x2));
  uint64_t x79 = ((uint64_t)(arg1[2]) * ((arg2[2]) * (uint32_t)0x2));
  uint64_t x80 = ((uint64_t)(arg1[2]) * ((arg2[1]) * (uint32_t)0x2));
  uint64_t x81 = ((uint64_t)(arg1[2]) * (arg2[0]));
  uint64_t x82 = ((uint64_t)(arg1[1]) * ((arg2[8]) * (uint32_t)0x2));
  uint64_t x83 = ((uint64_t)(arg1[1]) * ((arg2[7]) * (uint32_t)0x2));
  uint64_t x84 = ((uint64_t)(arg1[1]) * ((arg2[6]) * (uint32_t)0x2));
  uint64_t x85 = ((uint64_t)(arg1[1]) * ((arg2[5]) * (uint32_t)0x2));
  uint64_t x86 = ((uint64_t)(arg1[1]) * ((arg2[4]) * (uint32_t)0x2));
  uint64_t x87 = ((uint64_t)(arg1[1]) * ((arg2[3]) * (uint32_t)0x2));
  uint64_t x88 = ((uint64_t)(arg1[1]) * ((arg2[2]) * (uint32_t)0x2));
  ...
  fiat_p251_uint1 x145 = (fiat_p251_uint1)(x144 >> 25);
...
static void fiat_p251_carry_square(uint32_t out1[10], const uint32_t arg1[10]) {
  ...
  uint64_t x22 = ((uint64_t)(arg1[7]) * x2);
  uint64_t x23 = ((uint64_t)(arg1[7]) * x5);
  uint64_t x24 = ((uint64_t)(arg1[7]) * x7);
  uint64_t x25 = ((uint64_t)(arg1[6]) * x2);
  uint64_t x26 = ((uint64_t)(arg1[6]) * x5);
  uint64_t x27 = ((uint64_t)(arg1[6]) * x8);
  uint64_t x28 = ((uint64_t)(arg1[6]) * x10);
  uint64_t x29 = ((uint64_t)(arg1[5]) * x2);
  uint64_t x30 = ((uint64_t)(arg1[5]) * x5);
  uint64_t x31 = ((uint64_t)(arg1[5]) * x8);
  uint64_t x32 = ((uint64_t)(arg1[5]) * x11);
  uint64_t x33 = ((uint64_t)(arg1[5]) * (x13 * (uint32_t)0x2));
  uint64_t x34 = ((uint64_t)(arg1[4]) * x2);
  uint64_t x35 = ((uint64_t)(arg1[4]) * x5);
  uint64_t x36 = ((uint64_t)(arg1[4]) * x8);
  uint64_t x37 = ((uint64_t)(arg1[4]) * (x11 * (uint32_t)0x2));
  uint64_t x38 = ((uint64_t)(arg1[4]) * (x14 * (uint32_t)0x2));
  uint64_t x39 = ((uint64_t)(arg1[4]) * ((arg1[4]) * (uint32_t)0x2));
  uint64_t x40 = ((uint64_t)(arg1[3]) * x2);
  uint64_t x41 = ((uint64_t)(arg1[3]) * x5);
  uint64_t x42 = ((uint64_t)(arg1[3]) * (x8 * (uint32_t)0x2));
  uint64_t x43 = ((uint64_t)(arg1[3]) * (x12 * (uint32_t)0x2));
  uint64_t x44 = ((uint64_t)(arg1[3]) * (x14 * (uint32_t)0x2));
  uint64_t x45 = ((uint64_t)(arg1[3]) * (x15 * (uint32_t)0x2));
  uint64_t x46 = ((uint64_t)(arg1[3]) * ((arg1[3]) * (uint32_t)0x2));
  uint64_t x47 = ((uint64_t)(arg1[2]) * x2);
  uint64_t x48 = ((uint64_t)(arg1[2]) * (x5 * (uint32_t)0x2));
  uint64_t x49 = ((uint64_t)(arg1[2]) * (x9 * (uint32_t)0x2));
  uint64_t x50 = ((uint64_t)(arg1[2]) * (x12 * (uint32_t)0x2));
  uint64_t x51 = ((uint64_t)(arg1[2]) * (x14 * (uint32_t)0x2));
  uint64_t x52 = ((uint64_t)(arg1[2]) * (x15 * (uint32_t)0x2));
  uint64_t x53 = ((uint64_t)(arg1[2]) * (x16 * (uint32_t)0x2));
  uint64_t x54 = ((uint64_t)(arg1[2]) * ((arg1[2]) * (uint32_t)0x2));
  uint64_t x55 = ((uint64_t)(arg1[1]) * (x2 * (uint32_t)0x2));
  uint64_t x56 = ((uint64_t)(arg1[1]) * (x6 * (uint32_t)0x2));
  uint64_t x57 = ((uint64_t)(arg1[1]) * (x9 * (uint32_t)0x2));
  uint64_t x58 = ((uint64_t)(arg1[1]) * (x12 * (uint32_t)0x2));
  ...
  uint64_t x62 = ((uint64_t)(arg1[1]) * (x17 * (uint32_t)0x2));
 ...
 *   out1: [[0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333]]
 */
static void fiat_p251_carry(uint32_t out1[10], const uint32_t arg1[10]) {
  uint32_t x1 = (arg1[0]);
  uint32_t x2 = ((x1 >> 26) + (arg1[1]));
  uint32_t x3 = ((x2 >> 25) + (arg1[2]));
  uint32_t x4 = ((x3 >> 25) + (arg1[3]));
  uint32_t x5 = ((x4 >> 25) + (arg1[4]));
  uint32_t x6 = ((x5 >> 25) + (arg1[5]));
  uint32_t x7 = ((x6 >> 25) + (arg1[6]));
  uint32_t x8 = ((x7 >> 25) + (arg1[7]));
  uint32_t x9 = ((x8 >> 25) + (arg1[8]));
  uint32_t x10 = ((x9 >> 25) + (arg1[9]));
  uint32_t x11 = ((x1 & UINT32_C(0x3ffffff)) + ((x10 >> 25) * (uint32_t)0x9));
  uint32_t x12 = ((fiat_p251_uint1)(x11 >> 26) + (x2 & UINT32_C(0x1ffffff)));
  uint32_t x13 = (x11 & UINT32_C(0x3ffffff));
  uint32_t x14 = (x12 & UINT32_C(0x1ffffff));
  uint32_t x15 = ((fiat_p251_uint1)(x12 >> 25) + (x3 & UINT32_C(0x1ffffff)));
  uint32_t x16 = (x4 & UINT32_C(0x1ffffff));
  uint32_t x17 = (x5 & UINT32_C(0x1ffffff));
  uint32_t x18 = (x6 & UINT32_C(0x1ffffff));
  uint32_t x19 = (x7 & UINT32_C(0x1ffffff));
  uint32_t x20 = (x8 & UINT32_C(0x1ffffff));
  uint32_t x21 = (x9 & UINT32_C(0x1ffffff));
 ...
 *
 * Input Bounds:
 *   arg1: [[0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333]]
 *   arg2: [[0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333]]
 * Output Bounds:
 *   out1: [[0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999]]
 */
static void fiat_p251_add(uint32_t out1[10], const uint32_t arg1[10], const uint32_t arg2[10]) {
 ...
 *   out1: [[0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999]]
 */
static void fiat_p251_sub(uint32_t out1[10], const uint32_t arg1[10], const uint32_t arg2[10]) {
  uint32_t x1 = ((UINT32_C(0x7ffffee) + (arg1[0])) - (arg2[0]));
  ...
  uint32_t x9 = ((UINT32_C(0x3fffffe) + (arg1[8])) - (arg2[8]));
 ...
 *   out1: [[0x0 ~> 0xd333332], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999], [0x0 ~> 0x6999999]]
 */
static void fiat_p251_opp(uint32_t out1[10], const uint32_t arg1[10]) {
  uint32_t x1 = (UINT32_C(0x7ffffee) - (arg1[0]));
  ...
  uint32_t x9 = (UINT32_C(0x3fffffe) - (arg1[8]));
 ...
 */
static void fiat_p251_selectznz(uint32_t out1[10], fiat_p251_uint1 arg1, const uint32_t arg2[10], const uint32_t arg3[10]) {
  uint32_t x1;
  ...
  uint32_t x10;
  fiat_p251_cmovznz_u32(&x10, arg1, (arg2[9]), (arg3[9]));
  out1[0] = x1;
  out1[1] = x2;
  out1[2] = x3;
  out1[3] = x4;
 ...
 */
static void fiat_p251_to_bytes(uint8_t out1[32], const uint32_t arg1[10]) {
  uint32_t x1;
  fiat_p251_uint1 x2;
  fiat_p251_subborrowx_u26(&x1, &x2, 0x0, (arg1[0]), UINT32_C(0x3fffff7));
  uint32_t x3;
  fiat_p251_uint1 x4;
  fiat_p251_subborrowx_u25(&x3, &x4, x2, (arg1[1]), UINT32_C(0x1ffffff));
  uint32_t x5;
  fiat_p251_uint1 x6;
  fiat_p251_subborrowx_u25(&x5, &x6, x4, (arg1[2]), UINT32_C(0x1ffffff));
  uint32_t x7;
  fiat_p251_uint1 x8;
  fiat_p251_subborrowx_u25(&x7, &x8, x6, (arg1[3]), UINT32_C(0x1ffffff));
  uint32_t x9;
  fiat_p251_uint1 x10;
  fiat_p251_subborrowx_u25(&x9, &x10, x8, (arg1[4]), UINT32_C(0x1ffffff));
  uint32_t x11;
  fiat_p251_uint1 x12;
  fiat_p251_subborrowx_u25(&x11, &x12, x10, (arg1[5]), UINT32_C(0x1ffffff));
  uint32_t x13;
  fiat_p251_uint1 x14;
  fiat_p251_subborrowx_u25(&x13, &x14, x12, (arg1[6]), UINT32_C(0x1ffffff));
  uint32_t x15;
  fiat_p251_uint1 x16;
  fiat_p251_subborrowx_u25(&x15, &x16, x14, (arg1[7]), UINT32_C(0x1ffffff));
  uint32_t x17;
  fiat_p251_uint1 x18;
  fiat_p251_subborrowx_u25(&x17, &x18, x16, (arg1[8]), UINT32_C(0x1ffffff));
  uint32_t x19;
  fiat_p251_uint1 x20;
  fiat_p251_subborrowx_u25(&x19, &x20, x18, (arg1[9]), UINT32_C(0x1ffffff));
  uint32_t x21;
  fiat_p251_cmovznz_u32(&x21, x20, 0x0, UINT32_C(0xffffffff));
  uint32_t x22;
  fiat_p251_uint1 x23;
  fiat_p251_addcarryx_u26(&x22, &x23, 0x0, x1, (x21 & UINT32_C(0x3fffff7)));
  uint32_t x24;
  fiat_p251_uint1 x25;
  fiat_p251_addcarryx_u25(&x24, &x25, x23, x3, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x26;
  fiat_p251_uint1 x27;
  fiat_p251_addcarryx_u25(&x26, &x27, x25, x5, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x28;
  fiat_p251_uint1 x29;
  fiat_p251_addcarryx_u25(&x28, &x29, x27, x7, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x30;
  fiat_p251_uint1 x31;
  fiat_p251_addcarryx_u25(&x30, &x31, x29, x9, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x32;
  fiat_p251_uint1 x33;
  fiat_p251_addcarryx_u25(&x32, &x33, x31, x11, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x34;
  fiat_p251_uint1 x35;
  fiat_p251_addcarryx_u25(&x34, &x35, x33, x13, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x36;
  fiat_p251_uint1 x37;
  fiat_p251_addcarryx_u25(&x36, &x37, x35, x15, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x38;
  fiat_p251_uint1 x39;
  fiat_p251_addcarryx_u25(&x38, &x39, x37, x17, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x40;
  fiat_p251_uint1 x41;
  fiat_p251_addcarryx_u25(&x40, &x41, x39, x19, (x21 & UINT32_C(0x1ffffff)));
  uint32_t x42 = (x40 << 2);
  uint32_t x43 = (x38 * (uint32_t)0x2);
  uint32_t x44 = (x34 << 7);
  uint32_t x45 = (x32 << 6);
  uint32_t x46 = (x30 << 5);
  uint32_t x47 = (x28 << 4);
  ...
  uint32_t x99 = (x36 >> 8);
  uint8_t x100 = (uint8_t)(x36 & UINT8_C(0xff));
  uint32_t x101 = (x99 >> 8);
  uint8_t x102 = (uint8_t)(x99 & UINT8_C(0xff));
  fiat_p251_uint1 x103 = (fiat_p251_uint1)(x101 >> 8);
 ...
 *   out1: [[0x0 ~> 0x4666666], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333], [0x0 ~> 0x2333333]]
 */
static void fiat_p251_from_bytes(uint32_t out1[10], const uint8_t arg1[32]) {
  uint32_t x1 = ((uint32_t)(arg1[31]) << 22);
  uint32_t x2 = ((uint32_t)(arg1[30]) << 14);
  uint32_t x3 = ((uint32_t)(arg1[29]) << 6);
  uint32_t x4 = ((uint32_t)(arg1[28]) << 23);
  uint32_t x5 = ((uint32_t)(arg1[27]) << 15);
  uint32_t x6 = ((uint32_t)(arg1[26]) << 7);
  uint32_t x7 = ((uint32_t)(arg1[25]) << 24);
  uint32_t x8 = ((uint32_t)(arg1[24]) << 16);
  uint32_t x9 = ((uint32_t)(arg1[23]) << 8);
  uint8_t x10 = (arg1[22]);
  uint32_t x11 = ((uint32_t)(arg1[21]) << 17);
  uint32_t x12 = ((uint32_t)(arg1[20]) << 9);
  uint32_t x13 = ((uint32_t)(arg1[19]) * 0x2);
  uint32_t x14 = ((uint32_t)(arg1[18]) << 18);
  uint32_t x15 = ((uint32_t)(arg1[17]) << 10);
  uint32_t x16 = ((uint32_t)(arg1[16]) << 2);
  uint32_t x17 = ((uint32_t)(arg1[15]) << 19);
  uint32_t x18 = ((uint32_t)(arg1[14]) << 11);
  uint32_t x19 = ((uint32_t)(arg1[13]) << 3);
  uint32_t x20 = ((uint32_t)(arg1[12]) << 20);
  uint32_t x21 = ((uint32_t)(arg1[11]) << 12);
  uint32_t x22 = ((uint32_t)(arg1[10]) << 4);
  ...
  uint32_t x38 = (x10 + (x9 + (x8 + x7)));
  uint32_t x39 = (x13 + (x12 + x11));
  uint32_t x40 = (x16 + (x15 + x14));
  ...
  uint8_t x49 = (uint8_t)(x48 >> 25);
  uint32_t x50 = (x48 & UINT32_C(0x1ffffff));
  uint32_t x51 = (x49 + x42);
  uint8_t x52 = (uint8_t)(x51 >> 25);
  uint32_t x53 = (x51 & UINT32_C(0x1ffffff));
  uint32_t x54 = (x52 + x41);
  uint8_t x55 = (uint8_t)(x54 >> 25);
  uint32_t x56 = (x54 & UINT32_C(0x1ffffff));
  uint32_t x57 = (x55 + x40);
  fiat_p251_uint1 x58 = (fiat_p251_uint1)(x57 >> 25);
  uint32_t x59 = (x57 & UINT32_C(0x1ffffff));
  uint32_t x60 = (x58 + x39);
  uint32_t x61 = (x60 & UINT32_C(0x1ffffff));
  uint8_t x62 = (uint8_t)(x38 >> 25);
  uint32_t x63 = (x38 & UINT32_C(0x1ffffff));
  uint32_t x64 = (x62 + x37);
  uint8_t x65 = (uint8_t)(x64 >> 25);
  uint32_t x66 = (x64 & UINT32_C(0x1ffffff));
