...
private:
  ...
  static NAN_METHOD(Quorem);
  static NAN_METHOD(Iquo);
  static NAN_METHOD(Iquon);
  static NAN_METHOD(Irem);
  static NAN_METHOD(Iremn);
  static NAN_METHOD(Remrn);
  static NAN_METHOD(Divmod);
