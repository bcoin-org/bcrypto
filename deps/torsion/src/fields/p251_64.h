/* Autogenerated: /src/ExtractionOCaml/unsaturated_solinas --static p251 64 5 '2^251 - 9' add sub opp carry carry_mul carry_square carry_scmul3 carry_scmul4 carry_scmul8 carry_scmul1174 selectznz to_bytes from_bytes */
...
/* balance = [0xfffffffffffee, 0x7fffffffffffe, 0x7fffffffffffe, 0x7fffffffffffe, 0x7fffffffffffe] */
 ...
 *
 * Input Bounds:
 *   arg1: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000]]
 *   arg2: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000]]
 * Output Bounds:
 *   out1: [[0x0 ~> 0x18000000000000], [0x0 ~> 0xc000000000000], [0x0 ~> 0xc000000000000], [0x0 ~> 0xc000000000000], [0x0 ~> 0xc000000000000]]
 */
 ...
 *
 * Input Bounds:
 *   arg1: [[0x0 ~> 0x18000000000000], [0x0 ~> 0xc000000000000], [0x0 ~> 0xc000000000000], [0x0 ~> 0xc000000000000], [0x0 ~> 0xc000000000000]]
 * Output Bounds:
 *   out1: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000]]
 */
 ...
 * Input Bounds:
 *   arg1: [[0x0 ~> 0x18000000000000], [0x0 ~> 0xc000000000000], [0x0 ~> 0xc000000000000], [0x0 ~> 0xc000000000000], [0x0 ~> 0xc000000000000]]
 *   arg2: [[0x0 ~> 0x18000000000000], [0x0 ~> 0xc000000000000], [0x0 ~> 0xc000000000000], [0x0 ~> 0xc000000000000], [0x0 ~> 0xc000000000000]]
 * Output Bounds:
 *   out1: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000]]
 */
 ...
 *   out1: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000]]
 */
static void fiat_p251_carry_scmul_3(uint64_t out1[5], const uint64_t arg1[5]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
  ...
  x8 = (x6 + x4);
  x9 = (x8 >> 50);
  x10 = (x8 & UINT64_C(0x3ffffffffffff));
  x11 = (x9 + x3);
  x12 = (x11 >> 50);
  x13 = (x11 & UINT64_C(0x3ffffffffffff));
  x14 = (x12 + x2);
  x15 = (x14 >> 50);
  x16 = (x14 & UINT64_C(0x3ffffffffffff));
  x17 = (x15 + x1);
  x18 = (x17 >> 50);
  x19 = (x17 & UINT64_C(0x3ffffffffffff));
  x20 = (x18 * 0x9);
  x21 = (x7 + x20);
  x22 = (fiat_p251_uint1)(x21 >> 51);
  x23 = (x21 & UINT64_C(0x7ffffffffffff));
  x24 = (x22 + x10);
  x25 = (fiat_p251_uint1)(x24 >> 50);
  x26 = (x24 & UINT64_C(0x3ffffffffffff));
  x27 = (x25 + x13);
  out1[0] = x23;
  out1[1] = x26;
  out1[2] = x27;
 ...
 *   out1: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000]]
 */
static void fiat_p251_carry_scmul_4(uint64_t out1[5], const uint64_t arg1[5]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
 ...
 *   out1: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000]]
 */
static void fiat_p251_carry_scmul_8(uint64_t out1[5], const uint64_t arg1[5]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
 ...
 *   out1: [[0x0 ~> 0x8000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000], [0x0 ~> 0x4000000000000]]
 */
static void fiat_p251_carry_scmul_1174(uint64_t out1[5], const uint64_t arg1[5]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
  ...
  uint64_t x26;
  uint64_t x27;
  x1 = (UINT16_C(0x496) * (arg1[4]));
  x2 = (UINT16_C(0x496) * (arg1[3]));
  x3 = (UINT16_C(0x496) * (arg1[2]));
  x4 = (UINT16_C(0x496) * (arg1[1]));
  x5 = (UINT16_C(0x496) * (arg1[0]));
  x6 = (x5 >> 51);
  x7 = (x5 & UINT64_C(0x7ffffffffffff));
  x8 = (x6 + x4);
  x9 = (x8 >> 50);
...
static void fiat_p251_from_bytes(uint64_t out1[5], const uint8_t arg1[32]) {
  ...
  x45 = (x21 + x44);
  x46 = (x20 + x45);
  x47 = (x46 & UINT64_C(0x3ffffffffffff));
  x48 = (uint8_t)(x46 >> 50);
  ...
  x53 = (x15 + x52);
  x54 = (x14 + x53);
  x55 = (x54 & UINT64_C(0x3ffffffffffff));
  x56 = (fiat_p251_uint1)(x54 >> 50);
  x57 = (x13 + (uint64_t)x56);
  x58 = (x12 + x57);
  x59 = (x11 + x58);
  x60 = (x10 + x59);
  x61 = (x9 + x60);
  x62 = (x8 + x61);
  x63 = (x7 + x62);
  x64 = (x63 & UINT64_C(0x3ffffffffffff));
  x65 = (uint8_t)(x63 >> 50);
  x66 = (x6 + (uint64_t)x65);
  x67 = (x5 + x66);
  x68 = (x4 + x67);
