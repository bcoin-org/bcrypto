/* Autogenerated: /src/ExtractionOCaml/unsaturated_solinas --static p521 32 19 '2^521 - 1' add sub opp carry carry_mul carry_square carry_scmul3 carry_scmul4 carry_scmul8 selectznz to_bytes from_bytes */
...
/*
 * The function fiat_p521_carry_scmul_3 multiplies a field element by 3 and reduces the result.
 * Postconditions:
 ...
 *   out1: [[0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x8000000]]
 */
static void fiat_p521_carry_scmul_3(uint32_t out1[19], const uint32_t arg1[19]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
  ...
  x19 = ((arg1[0]) * 0x3);
  x20 = (x19 >> 28);
  x21 = (x19 & UINT32_C(0xfffffff));
  x22 = (x20 + x18);
  x23 = (x22 >> 27);
  x24 = (x22 & UINT32_C(0x7ffffff));
  x25 = (x23 + x17);
  x26 = (x25 >> 28);
  x27 = (x25 & UINT32_C(0xfffffff));
  x28 = (x26 + x16);
  x29 = (x28 >> 27);
  x30 = (x28 & UINT32_C(0x7ffffff));
  x31 = (x29 + x15);
  x32 = (x31 >> 28);
  x33 = (x31 & UINT32_C(0xfffffff));
  x34 = (x32 + x14);
  x35 = (x34 >> 27);
  x36 = (x34 & UINT32_C(0x7ffffff));
  x37 = (x35 + x13);
  x38 = (x37 >> 27);
  x39 = (x37 & UINT32_C(0x7ffffff));
  x40 = (x38 + x12);
  x41 = (x40 >> 28);
  x42 = (x40 & UINT32_C(0xfffffff));
  x43 = (x41 + x11);
  x44 = (x43 >> 27);
  x45 = (x43 & UINT32_C(0x7ffffff));
  x46 = (x44 + x10);
  x47 = (x46 >> 28);
  x48 = (x46 & UINT32_C(0xfffffff));
  x49 = (x47 + x9);
  x50 = (x49 >> 27);
  x51 = (x49 & UINT32_C(0x7ffffff));
  x52 = (x50 + x8);
  x53 = (x52 >> 28);
  x54 = (x52 & UINT32_C(0xfffffff));
  x55 = (x53 + x7);
  x56 = (x55 >> 27);
  x57 = (x55 & UINT32_C(0x7ffffff));
  x58 = (x56 + x6);
  x59 = (x58 >> 27);
  x60 = (x58 & UINT32_C(0x7ffffff));
  x61 = (x59 + x5);
  x62 = (x61 >> 28);
  x63 = (x61 & UINT32_C(0xfffffff));
  x64 = (x62 + x4);
  x65 = (x64 >> 27);
  x66 = (x64 & UINT32_C(0x7ffffff));
  x67 = (x65 + x3);
  x68 = (x67 >> 28);
  x69 = (x67 & UINT32_C(0xfffffff));
  x70 = (x68 + x2);
  x71 = (x70 >> 27);
  x72 = (x70 & UINT32_C(0x7ffffff));
  x73 = (x71 + x1);
  x74 = (x73 >> 27);
  x75 = (x73 & UINT32_C(0x7ffffff));
  x76 = (x21 + x74);
  x77 = (fiat_p521_uint1)(x76 >> 28);
  x78 = (x76 & UINT32_C(0xfffffff));
  x79 = (x77 + x24);
  x80 = (fiat_p521_uint1)(x79 >> 27);
  x81 = (x79 & UINT32_C(0x7ffffff));
  x82 = (x80 + x27);
  out1[0] = x78;
  out1[1] = x81;
  out1[2] = x82;
...
/*
 * The function fiat_p521_carry_scmul_4 multiplies a field element by 4 and reduces the result.
 * Postconditions:
 ...
 *   out1: [[0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x8000000]]
 */
static void fiat_p521_carry_scmul_4(uint32_t out1[19], const uint32_t arg1[19]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
...
/*
 * The function fiat_p521_carry_scmul_8 multiplies a field element by 8 and reduces the result.
 * Postconditions:
 ...
 *   out1: [[0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x10000000], [0x0 ~> 0x8000000], [0x0 ~> 0x8000000]]
 */
static void fiat_p521_carry_scmul_8(uint32_t out1[19], const uint32_t arg1[19]) {
  uint32_t x1;
  uint32_t x2;
  uint64_t x3;
  uint32_t x4;
  ...
  x1 = ((arg1[18]) << 3);
  x2 = ((arg1[17]) << 3);
  x3 = ((uint64_t)(arg1[16]) << 3);
  x4 = ((arg1[15]) << 3);
  x5 = ((uint64_t)(arg1[14]) << 3);
  x6 = ((arg1[13]) << 3);
  x7 = ((arg1[12]) << 3);
  x8 = ((uint64_t)(arg1[11]) << 3);
  x9 = ((arg1[10]) << 3);
  x10 = ((uint64_t)(arg1[9]) << 3);
  x11 = ((arg1[8]) << 3);
  x12 = ((uint64_t)(arg1[7]) << 3);
  x13 = ((arg1[6]) << 3);
  x14 = ((arg1[5]) << 3);
  x15 = ((uint64_t)(arg1[4]) << 3);
  x16 = ((arg1[3]) << 3);
  x17 = ((uint64_t)(arg1[2]) << 3);
  x18 = ((arg1[1]) << 3);
  x19 = ((uint64_t)(arg1[0]) << 3);
  x20 = (uint32_t)(x19 >> 28);
  x21 = (uint32_t)(x19 & UINT32_C(0xfffffff));
  x22 = (x20 + x18);
  x23 = (x22 >> 27);
  x24 = (x22 & UINT32_C(0x7ffffff));
  x25 = (x23 + x17);
  x26 = (uint32_t)(x25 >> 28);
  x27 = (uint32_t)(x25 & UINT32_C(0xfffffff));
  x28 = (x26 + x16);
  x29 = (x28 >> 27);
  x30 = (x28 & UINT32_C(0x7ffffff));
  x31 = (x29 + x15);
  x32 = (uint32_t)(x31 >> 28);
  x33 = (uint32_t)(x31 & UINT32_C(0xfffffff));
  x34 = (x32 + x14);
  x35 = (x34 >> 27);
  x36 = (x34 & UINT32_C(0x7ffffff));
  x37 = (x35 + x13);
  ...
  x40 = (x38 + x12);
  x41 = (uint32_t)(x40 >> 28);
  x42 = (uint32_t)(x40 & UINT32_C(0xfffffff));
  x43 = (x41 + x11);
  x44 = (x43 >> 27);
  x45 = (x43 & UINT32_C(0x7ffffff));
  x46 = (x44 + x10);
  x47 = (uint32_t)(x46 >> 28);
  x48 = (uint32_t)(x46 & UINT32_C(0xfffffff));
  x49 = (x47 + x9);
  x50 = (x49 >> 27);
  x51 = (x49 & UINT32_C(0x7ffffff));
  x52 = (x50 + x8);
  x53 = (uint32_t)(x52 >> 28);
  x54 = (uint32_t)(x52 & UINT32_C(0xfffffff));
  x55 = (x53 + x7);
  x56 = (x55 >> 27);
  x57 = (x55 & UINT32_C(0x7ffffff));
  x58 = (x56 + x6);
  ...
  x61 = (x59 + x5);
  x62 = (uint32_t)(x61 >> 28);
  x63 = (uint32_t)(x61 & UINT32_C(0xfffffff));
  x64 = (x62 + x4);
  x65 = (x64 >> 27);
  x66 = (x64 & UINT32_C(0x7ffffff));
  x67 = (x65 + x3);
  x68 = (uint32_t)(x67 >> 28);
  x69 = (uint32_t)(x67 & UINT32_C(0xfffffff));
  x70 = (x68 + x2);
  x71 = (x70 >> 27);
  x72 = (x70 & UINT32_C(0x7ffffff));
  x73 = (x71 + x1);
