/* Autogenerated: /src/ExtractionOCaml/unsaturated_solinas --static p521 64 9 '2^521 - 1' add sub opp carry carry_mul carry_square carry_scmul3 carry_scmul4 carry_scmul8 selectznz to_bytes from_bytes */
 ...
 *   out1: [[0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x200000000000000]]
 */
static void fiat_p521_carry_scmul_3(uint64_t out1[9], const uint64_t arg1[9]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
  ...
  x9 = ((arg1[0]) * 0x3);
  x10 = (x9 >> 58);
  x11 = (x9 & UINT64_C(0x3ffffffffffffff));
  x12 = (x10 + x8);
  x13 = (x12 >> 58);
  x14 = (x12 & UINT64_C(0x3ffffffffffffff));
  x15 = (x13 + x7);
  x16 = (x15 >> 58);
  x17 = (x15 & UINT64_C(0x3ffffffffffffff));
  x18 = (x16 + x6);
  x19 = (x18 >> 58);
  x20 = (x18 & UINT64_C(0x3ffffffffffffff));
  x21 = (x19 + x5);
  x22 = (x21 >> 58);
  x23 = (x21 & UINT64_C(0x3ffffffffffffff));
  x24 = (x22 + x4);
  x25 = (x24 >> 58);
  x26 = (x24 & UINT64_C(0x3ffffffffffffff));
  x27 = (x25 + x3);
  x28 = (x27 >> 58);
  x29 = (x27 & UINT64_C(0x3ffffffffffffff));
  x30 = (x28 + x2);
  x31 = (x30 >> 58);
  x32 = (x30 & UINT64_C(0x3ffffffffffffff));
  x33 = (x31 + x1);
  x34 = (x33 >> 57);
  x35 = (x33 & UINT64_C(0x1ffffffffffffff));
  x36 = (x11 + x34);
  x37 = (fiat_p521_uint1)(x36 >> 58);
  x38 = (x36 & UINT64_C(0x3ffffffffffffff));
  x39 = (x37 + x14);
  x40 = (fiat_p521_uint1)(x39 >> 58);
  x41 = (x39 & UINT64_C(0x3ffffffffffffff));
  x42 = (x40 + x17);
  out1[0] = x38;
  out1[1] = x41;
  out1[2] = x42;
 ...
 *   out1: [[0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x200000000000000]]
 */
static void fiat_p521_carry_scmul_4(uint64_t out1[9], const uint64_t arg1[9]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
 ...
 *   out1: [[0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x400000000000000], [0x0 ~> 0x200000000000000]]
 */
static void fiat_p521_carry_scmul_8(uint64_t out1[9], const uint64_t arg1[9]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
