/* Autogenerated: /src/ExtractionOCaml/unsaturated_solinas --static p25519 32 10 '2^255 - 19' add sub opp carry carry_mul carry_square carry_scmul3 carry_scmul4 carry_scmul8 carry_scmul121666 selectznz to_bytes from_bytes */
...
static void fiat_p25519_carry(uint32_t out1[10], const uint32_t arg1[10]) {
  ...
  x12 = ((fiat_p25519_uint1)(x11 >> 26) + (x2 & UINT32_C(0x1ffffff)));
  x13 = (x11 & UINT32_C(0x3ffffff));
  x14 = (x12 & UINT32_C(0x1ffffff));
  x15 = ((fiat_p25519_uint1)(x12 >> 25) + (x3 & UINT32_C(0x3ffffff)));
...
static void fiat_p25519_carry_mul(uint32_t out1[10], const uint32_t arg1[10], const uint32_t arg2[10]) {
  ...
  x144 = (x142 + x115);
  x145 = (fiat_p25519_uint1)(x144 >> 25);
...
static void fiat_p25519_carry_square(uint32_t out1[10], const uint32_t arg1[10]) {
  ...
  x117 = (x115 + x88);
  x118 = (fiat_p25519_uint1)(x117 >> 25);
 ...
 *   out1: [[0x0 ~> 0x4000000], [0x0 ~> 0x2000000], [0x0 ~> 0x4000000], [0x0 ~> 0x2000000], [0x0 ~> 0x4000000], [0x0 ~> 0x2000000], [0x0 ~> 0x4000000], [0x0 ~> 0x2000000], [0x0 ~> 0x4000000], [0x0 ~> 0x2000000]]
 */
static void fiat_p25519_carry_scmul_3(uint32_t out1[10], const uint32_t arg1[10]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
  ...
  uint32_t x40;
  uint32_t x41;
  fiat_p25519_uint1 x42;
  uint32_t x43;
  uint32_t x44;
  fiat_p25519_uint1 x45;
  uint32_t x46;
  uint32_t x47;
  x1 = ((arg1[9]) * 0x3);
  x2 = ((arg1[8]) * 0x3);
  ...
  x22 = (x20 + x6);
  x23 = (x22 >> 26);
  x24 = (x22 & UINT32_C(0x3ffffff));
  x25 = (x23 + x5);
  x26 = (x25 >> 25);
  x27 = (x25 & UINT32_C(0x1ffffff));
  x28 = (x26 + x4);
  x29 = (x28 >> 26);
  x30 = (x28 & UINT32_C(0x3ffffff));
  x31 = (x29 + x3);
  x32 = (x31 >> 25);
  x33 = (x31 & UINT32_C(0x1ffffff));
  x34 = (x32 + x2);
  x35 = (x34 >> 26);
  x36 = (x34 & UINT32_C(0x3ffffff));
  x37 = (x35 + x1);
  x38 = (x37 >> 25);
  x39 = (x37 & UINT32_C(0x1ffffff));
  x40 = (x38 * UINT8_C(0x13));
  x41 = (x12 + x40);
  x42 = (fiat_p25519_uint1)(x41 >> 26);
  x43 = (x41 & UINT32_C(0x3ffffff));
  x44 = (x42 + x15);
  x45 = (fiat_p25519_uint1)(x44 >> 25);
 ...
 *   out1: [[0x0 ~> 0x4000000], [0x0 ~> 0x2000000], [0x0 ~> 0x4000000], [0x0 ~> 0x2000000], [0x0 ~> 0x4000000], [0x0 ~> 0x2000000], [0x0 ~> 0x4000000], [0x0 ~> 0x2000000], [0x0 ~> 0x4000000], [0x0 ~> 0x2000000]]
 */
static void fiat_p25519_carry_scmul_4(uint32_t out1[10], const uint32_t arg1[10]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *   out1: [[0x0 ~> 0x4000000], [0x0 ~> 0x2000000], [0x0 ~> 0x4000000], [0x0 ~> 0x2000000], [0x0 ~> 0x4000000], [0x0 ~> 0x2000000], [0x0 ~> 0x4000000], [0x0 ~> 0x2000000], [0x0 ~> 0x4000000], [0x0 ~> 0x2000000]]
 */
static void fiat_p25519_carry_scmul_8(uint32_t out1[10], const uint32_t arg1[10]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
