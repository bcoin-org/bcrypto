/*!
 * digest.js - hash functions for bcrypto
...
const Keccak384 = require('./keccak384');
...
const SHA3_384 = require('./sha3-384');
...
exports.keccak384 = wrap(Keccak384, function keccak(data) {
  return Keccak384.digest(data);
});
...
exports.sha3_384 = wrap(SHA3_384, function sha3_384(data) {
  return SHA3_384.digest(data);
});
