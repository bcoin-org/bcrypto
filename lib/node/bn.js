...
class Red {
  ...
  isqrt(a) {
    ...
    if (this.prime && (this.m & 7n) === 5n) {
      if (this.sm1 === null) {
        const e = (this.m - 1n) >> 2n;

        this.sm1 = powm(2n, e, this.m);
      }
    }

    a.n = sqrtm(a.n, this.m, this.sm1);
