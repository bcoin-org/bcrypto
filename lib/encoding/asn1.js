...
class Node extends bio.Struct {
  ...
  write(bw, extra) {
    ...
    switch (this.mode) {
      ...
      case NORMAL: {
        const primitive = this.type !== asnTypes.SEQUENCE
                       && this.type !== asnTypes.SET;
...
class Any extends Node {
  ...
  clean() {
    return this.node.type === asnTypes.NULL;
  }
  ...
  format() {
    return `<${this.constructor.name}: ${this.node.format()}>`;
  }
...
function typeToClass(type) {
  ...
  switch (type) {
    case asnTypes.BOOLEAN:
      return Bool;
    case asnTypes.INTEGER:
      return Integer;
    case asnTypes.BITSTRING:
      return BitString;
    case asnTypes.OCTSTRING:
      return OctString;
    case asnTypes.NULL:
      return Null;
    case asnTypes.OID:
    ...
    case asnTypes.PRINTSTRING:
      return PrintString;
    case asnTypes.T61STRING:
      return T61String;
    case asnTypes.IA5STRING:
      return IA5String;
    case asnTypes.UTCTIME:
      return UTCTime;
    case asnTypes.GENTIME:
      return GenTime;
    case asnTypes.GENSTRING:
      return GenString;
    default:
