...
/**
 * RNG (designed to mimic the RNG in secp256k1-zkp)
...
class RNG {
  ...
  encrypt(counter) {
    ...
    this.ctx.init(this.key, this.iv, counter);
    this.ctx.encrypt(data);
