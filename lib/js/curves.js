...
class Curve {
  ...
  init(type, conf) {
    ...
    // Temporary arrays.
    this._wnafT1 = makeArray(4);
    this._wnafT2 = makeArray(4);
    this._wnafT3 = makeArray(4);
    this._wnafT4 = makeArray(4);
...
class ShortCurve extends Curve {
  constructor(conf) {
    ...
    this._endoWnafT1 = makeArray(4);
    this._endoWnafT2 = makeArray(4);
  }
