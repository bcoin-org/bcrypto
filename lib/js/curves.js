...
class Curve {
  ...
  init(type, conf) {
    ...
    this.zeroRaw = this.encodeScalar(new BN(0));
    this.orderRaw = this.n ? this.encodeScalar(this.n) : null;
    this.halfRaw = this.nh ? this.encodeScalar(this.nh) : null;
    this.cofactorRaw = this.h ? this.encodeScalar(this.h) : null;
