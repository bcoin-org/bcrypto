...
class Curve {
  ...
  init(type, conf) {
    ...
    this.h = conf.h ? new BN(conf.h, 16) : null;
    this.hc = conf.h ? Math.log2(this.h.toNumber()) | 0 : 0;
  ...
  constructor(pre) {
    super({
      ...
      g: [
        ...
        '1',
        // (x * y * t^-1) mod p
        ['67875f0f d78b7665 66ea4e8e 64abe37d',
         '20f09f80 775152f5 6dde8ab3 a5b7dda3'].join(''),
        pre
      ]
    });
  }
