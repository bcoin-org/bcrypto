...
class Point {
  ...
  precompute(power, rng) {
    ...
    if (!this.precomputed.blinding)
      this.precomputed.blinding = this._getBlinding(rng, 1);
  ...
  _mulBlind(k, rng = null, jacobian) {
    ...
    const blinding = this._getBlinding(rng, 0);
  ...
  mulConst(k, rng = null) {
    return this._mulConst(k, rng, false);
  }

  jmulConst(k, rng = null) {
    return this._mulConst(k, rng, true);
  }
