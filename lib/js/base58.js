...
function encode(data) {
  ...
  const b58len = (((data.length - zeroes) * 138 / 100) | 0) + 1;
  const b58 = Buffer.allocUnsafe(b58len);
...
function decode(str) {
  ...
  const b256len = ((str.length * 733) / 1000 | 0) + 1;
  const b256 = Buffer.allocUnsafe(b256len);
  ...
  const out = Buffer.alloc(zeroes + (b256.length - i));
