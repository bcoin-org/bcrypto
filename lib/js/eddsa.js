...
class EDDSA {
  ...
  deriveWithScalar(pub, scalar) {
    // TODO: Clamp this to mirror x25519/x448.
    // This means we couldn't use HD keys here.
    // This should be fine considering one can
    // use privateKeyTweakMul in its place.
