...
//   (0, -c) as if it were infinity due to the 4-isogeny
//   between Curve448 and Ed448. We replicate this behavior.
//
...
class EDDSA {
  ...
  publicKeyFromUniform(bytes) {
    ...
    const p = this.curve.elligator(this.x, r);
  ...
  publicKeyToUniform(pub) {
    ...
    const r = this.curve.invert(this.x, p);
