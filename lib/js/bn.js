...
class BN {
  ...
  iudiv(num) {
    return this.udiv(num)._move(this);
  }

  iudivn(num) {
    const r = this.modrn(num);
  ...
  umod(num) {
    return this._div(num, modes.MOD | modes.EUCLID)[1];
  }
  ...
  lcm(num) {
    ...
    return this.div(this.gcd(num)).mul(num).iabs();
  }
