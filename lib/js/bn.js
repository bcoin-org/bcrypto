...
class BN {
  ...
  iandn(num) {
    ...
    if ((this.negative | Number(num < 0)) !== 0)
  ...
  ucmpn(num) {
    ...
    return Number(w > num) - Number(w < num);
  }
...
next:
  ...
  fromBigInt(num, endian) {
    ...
    // as fast as bigints.
    const start = Number(num < BigInt(0)) | 0;
