...
class CipherBase {
  ...
  _init(name) {
    ...
    switch (algo) {
      ...
      case 'RC2-GUTMANN': {
        this.ctx = new Mode(new RC2(-1, 0));
        break;
      }

      case 'RC2-40': {
        this.ctx = new Mode(new RC2(40));
        break;
      }

      case 'RC2-64': {
        this.ctx = new Mode(new RC2(64));
        break;
      }

      case 'RC2-128': {
        this.ctx = new Mode(new RC2(128));
        break;
      }

      case 'RC2-128-GUTMANN': {
        this.ctx = new Mode(new RC2(128, 1024));
        break;
      }
  ...
  setCCM(msgLength, tagLength, aad) {
    this.ctx.setCCM(msgLength, tagLength, aad);
    return this;
  }
