...
class ShortCurve extends Curve {
  ...
  _short(a0, sign) {
    ...
    //
    // See: Guide to Elliptic Curve Cryptography.
    //   Page 84, Section 3.1.5.
    //
    // Also: Alternative Elliptic Curve Representations.
    //   R. Struik.
    //   Appendix F.3 (Isomorphic Mapping between Weierstrass Curves).
    //   https://tools.ietf.org/id/draft-ietf-lwig-curve-representations-02.html#Wei-isom
    //
...
class JPoint extends Point {
  ...
  validate() {
    // See: Guide to Elliptic Curve Cryptography.
    // Example 3.20, Page 88, Section 3.
  ...
  _dblp(pow) {
    ...
    //
    // See: Guide to Elliptic Curve Cryptography.
    // Algorithm 3.23, Page 93, Section 3.2.
    //
    // Modified version of:
    //   https://hyperelliptic.org/EFD/g1p/auto-shortw-jacobian.html#doubling-dbl-1998-cmo-2
    //
...
class EdwardsCurve extends Curve {
  ...
  _elligator1(t) {
    ...
    //   https://elligator.cr.yp.to/elligator-20130828.pdf
    //
    // Also: Injective Encodings to Elliptic Curves.
