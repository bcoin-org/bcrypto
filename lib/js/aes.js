...
function encrypt(data, key, iv, bits = 256, chain = false) {
...
function decrypt(data, key, iv, bits = 256, chain = false) {
...
exports.encipher = function encipher(data, key, iv) {
  return encrypt(data, key, iv, 256, true);
};
...
exports.decipher = function decipher(data, key, iv) {
  return decrypt(data, key, iv, 256, true);
};
