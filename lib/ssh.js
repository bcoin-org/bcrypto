...
class SSHPrivateKey extends bio.Struct {
  ...
  encodeSSH(passwd) {
    ...
    const bw = /** @type {StaticWriter} */(bio.write(8192));
  ...
  decodeSSH(data, passwd) {
    ...
    const publicKey = /** @type {SSHPublicKey} */(SSHPublicKey.decode(pubRaw));
    ...
    const priv = /** @type {RawPrivateKey} */(RawPrivateKey.decode(privRaw));
