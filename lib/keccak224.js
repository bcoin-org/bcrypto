...
class Keccak224 extends Keccak {
  ...
  static hmac() {
    return super.hmac(224, 0x01);
  }

  static digest(data) {
    return super.digest(data, 224, 0x01);
  }

  static root(left, right) {
    return super.root(left, right, 224, 0x01);
  }

  static multi(one, two, three) {
    return super.multi(one, two, three, 224, 0x01);
  }

  static mac(data, key) {
    return super.mac(data, key, 224, 0x01);
  }
}
