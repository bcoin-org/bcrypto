...
function deserialize(str, prefix) {
  ...
  return binding.cash32_deserialize(str, prefix);
}
...
function is(str, prefix) {
  ...
  return binding.cash32_is(str, prefix);
}
...
function decode(str, prefix = 'bitcoincash') {
  ...
  return binding.cash32_decode(str, prefix);
}
...
function test(str, prefix = 'bitcoincash') {
  ...
  return binding.cash32_test(str, prefix);
}
