...
function decode(str, expect = 'bitcoincash') {
  assert(typeof str === 'string');
  assert(typeof expect === 'string');

  return binding.cash32_decode(str, expect);
}

function test(str, expect = 'bitcoincash') {
  assert(typeof str === 'string');
  assert(typeof expect === 'string');

  return binding.cash32_test(str, expect);
}
