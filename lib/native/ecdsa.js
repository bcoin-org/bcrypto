...
class ECDSA {
  constructor(name) {
    ...
    this._define('Key', () => this.Key);
    this._define('PublicKey', () => this.PublicKey);
    this._define('PrivateKey', () => this.PrivateKey);
    this._define('Signature', () => this.Signature);
  }
  ...
  get _keys() {
    if (!this._key)
      this._key = require('../internal/eckey')(this);
    return this._key;
  }
  ...
  get Signature() {
    if (!this._sig)
      this._sig = require('../internal/ecsig')(this);
    return this._sig;
  }
