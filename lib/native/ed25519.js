...
ed25519.signTweakAdd = function signTweakAdd(msg, secret, tweak) {
  return binding.signTweakAdd(msg, secret, tweak);
};
...
ed25519.signTweakMul = function signTweakMul(msg, secret, tweak) {
  return binding.signTweakMul(msg, secret, tweak);
};
