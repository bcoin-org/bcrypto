...
function publicKeyDeconvert(key, sign) {
 ...
 * Run uniform bytes through elligator2.
 * @param {Buffer} bytes
 * @returns {Buffer} X25519 key
 */

function pointFromUniform(bytes) {
  return binding.pointFromUniform(bytes);
}
...
/**
 * Convert public key to uniform bytes.
 * @param {Buffer} pub - X25519 key.
 * @returns {Buffer}
 */

function pointToUniform(pub, sign) {
  return binding.pointToUniform(pub, sign);
}
...
function pointFromHash(bytes) {
  return binding.pointFromHash(bytes);
}
...
function pointVerify(key) {
  return binding.pointVerify(key);
}
...
function pointIsSmall(key) {
  return binding.pointIsSmall(key);
}
...
function pointHasTorsion(key) {
  return binding.pointHasTorsion(key);
}
...
function exchangeWithScalar(pub, scalar) {
...
exports.publicKeyDeconvert = publicKeyDeconvert;
exports.publicKeyFromUniform = publicKeyFromUniform;
exports.pointFromUniform = pointFromUniform;
exports.publicKeyToUniform = publicKeyToUniform;
exports.pointToUniform = pointToUniform;
exports.publicKeyFromHash = publicKeyFromHash;
exports.pointFromHash = pointFromHash;
...
exports.pointVerify = pointVerify;
exports.pointIsSmall = pointIsSmall;
exports.pointHasTorsion = pointHasTorsion;
...
exports.exchangeWithScalar = exchangeWithScalar;
