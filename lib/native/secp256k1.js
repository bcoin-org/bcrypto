...
secp256k1.privateKeyReduce = function privateKeyReduce(key) {
...
secp256k1.privateKeyInvert = function privateKeyInvert(key) {
...
secp256k1.signatureNormalize = function signatureNormalize(sig) {
