...
secp256k1.privateKeyImport = function privateKeyImport(raw) {
  ...
  if (!this.privateKeyVerify(pki.key))
...
secp256k1.privateKeyExportJWK = function privateKeyExportJWK(key, compress) {
  return eckey.privateKeyExportJWK(this, key, compress);
};
...
secp256k1.publicKeyExportJWK = function publicKeyExportJWK(key, compress) {
  return eckey.publicKeyExportJWK(this, key, compress);
};
