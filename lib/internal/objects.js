...
const attrsByVal = {
  ...
  [attrs.EMAILADDRESS]: 'EMAILADDRESS'
};
...
const keyAlgs = {
  ...
  RSAPublicKey: '1.2.840.113549.1.1.1',
...
const keyAlgsByVal = {
  ...
  [keyAlgs.DSA]: 'DSA',
  [keyAlgs.DSA_ALT]: 'DSA',
  [keyAlgs.RSAPublicKey]: 'RSAPublicKey',
  [keyAlgs.ECDSA]: 'ECDSA',
  [keyAlgs.EDDSA]: 'EDDSA'
};
...
const sigAlgsByVal = {
  ...
  [sigAlgs.ECDSASHA256]: 'ECDSASHA256',
...
const extensions = {
  ...
  AuthorityInfoAccessKeyId: '2.5.29.35',
...
const extensionsByVal = {
  ...
  [extensions.AuthorityKeyId]: 'AuthorityKeyId',
  [extensions.BasicConstraints]: 'BasicConstraints',
  [extensions.SubjectAltName]: 'SubjectAltName',
  [extensions.PrivateKeyUsagePeriod]: 'PrivateKeyUsagePeriod',
  [extensions.CertificatePolicies]: 'CertificatePolicies',
  [extensions.NameConstraints]: 'NameConstraints',
  ...
  [extensions.EntrustVersInfo]: 'EntrustVersInfo',
  [extensions.HashedRootKey]: 'HashedRootKey'
};
...
exports.extensionsByVal = extensionsByVal;
