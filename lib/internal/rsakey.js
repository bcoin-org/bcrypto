...
class RSAPublicKey extends RSAKey {
  ...
  verify(hash, msg, sig) {
    return this.rsa.verify(hash, msg, sig, this);
  }

  encrypt(msg) {
    return this.rsa.encrypt(msg, this);
  }

  encryptOAEP(hash, msg, label) {
    return this.rsa.encryptOAEP(hash, msg, label, this);
  }
...
class RSAPrivateKey extends RSAKey {
  ...
  validate() {
    ...
    return this.rsa.validate(this);
  }

  compute() {
    this.rsa.compute(this);
    return this;
  }

  sign(hash, msg) {
    return this.rsa.sign(hash, msg, this);
  }
  ...
  decrypt(msg) {
    return this.rsa.decrypt(msg, this);
  }
  ...
  decryptOAEP(hash, msg, label) {
    return this.rsa.decryptOAEP(hash, msg, label, this);
  }
  ...
  toPublic() {
    const pub = new this.rsa.RSAPublicKey();
  ...
  static generate(bits, exponent) {
    return this.rsa.generate(bits, exponent);
  }

  static async generateAsync(bits, exponent) {
    return this.rsa.generateAsync(bits, exponent);
  }
}
