...
class Keccak256 extends Keccak {
  ...
  static hmac() {
    return super.hmac(256, 0x01);
  }

  static digest(data) {
    return super.digest(data, 256, 0x01);
  }

  static root(left, right) {
    return super.root(left, right, 256, 0x01);
  }

  static multi(one, two, three) {
    return super.multi(one, two, three, 256, 0x01);
  }

  static mac(data, key) {
    return super.mac(data, key, 256, 0x01);
  }
}
