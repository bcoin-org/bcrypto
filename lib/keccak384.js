...
class Keccak384 extends Keccak {
  ...
  static hmac() {
    return super.hmac(384, 0x01);
  }

  static digest(data) {
    return super.digest(data, 384, 0x01);
  }

  static root(left, right) {
    return super.root(left, right, 384, 0x01);
  }

  static multi(one, two, three) {
    return super.multi(one, two, three, 384, 0x01);
  }

  static mac(data, key) {
    return super.mac(data, key, 384, 0x01);
  }
}
