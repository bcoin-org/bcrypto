...
var elliptic = require('../../vendor/elliptic');
var Signature = require('../../vendor/elliptic/lib/elliptic/ec/signature');
var BN = require('bn.js');
var hash = require('../../vendor/hash.js');
  ...
  function test(name) {
    describe('curve ' + name, function() {
      ...
      it('should have `signature.s <= keys.ec.nh`', function() {
        ...
        var sign = keys.sign('68656c6c6f', { canonical: true });
